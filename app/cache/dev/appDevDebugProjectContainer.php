...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Development/symfony-standard/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Framework', '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Security', '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Twig', '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Swiftmailer', '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/SwiftmailerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'Doctrine', '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/DoctrineBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemo', '/Development/symfony-standard/src/Acme/DemoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfiler', '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SymfonyWebConfigurator', '/Development/symfony-standard/vendor/bundles/Symfony/Bundle/WebConfiguratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/Development/symfony-standard/app/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_e17fff04c24be8a8a0dceaed75110317');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e17fff04c24be8a8a0dceaed75110317');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e17fff04c24be8a8a0dceaed75110317');
        ...
        $d->setProxyDir('/Development/symfony-standard/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getLoggerService()
    {
        ...
        $b = new \Zend\Log\Writer\Stream('/Development/symfony-standard/app/logs/dev.log');
        $b->addFilter($a);
...
'));
    ...
    {
        require_once '/Development/symfony-standard/vendor/swiftmailer/lib/swift_init.php';
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/Development/symfony-standard/app/cache/dev', 'appdevUrlMatcher', 'appdevUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/Development/symfony-standard/app/config/routing_dev.yml', array('cache_dir' => '/Development/symfony-standard/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'resource_type' => ''));
    }
    ...
    {
        return $this->services['symfony.webconfigurator'] = new \Symfony\Bundle\WebConfiguratorBundle\Configurator('/Development/symfony-standard/app');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper('', '/Development/symfony-standard/app');
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/Development/symfony-standard/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/Development/symfony-standard/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), '/Development/symfony-standard/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Development/symfony-standard/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['profiler.storage'] = new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/Development/symfony-standard/app/cache/dev/profiler.db', '', '', 86400);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Development/symfony-standard/app/Resources');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader(array('validation' => 'Symfony\\Component\\Validator\\Constraints\\')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader('loadValidatorMetadata'), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Development/symfony-standard/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Development/symfony-standard/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Development/symfony-standard/app/cache/dev',
            'kernel.logs_dir' => '/Development/symfony-standard/app/logs',
            'kernel.bundles' => array(
                ...
                'AcmeDemo' => 'Acme\\DemoBundle\\AcmeDemoBundle',
            ...
            'routing.resource' => '/Development/symfony-standard/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Development/symfony-standard/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
...
',
            ...
            'zend.logger.path' => '/Development/symfony-standard/app/logs/dev.log',
            'swiftmailer.class' => 'Swift_Mailer',
            'swiftmailer.transport.sendmail.class' => 'Swift_Transport_SendmailTransport',
            'swiftmailer.transport.mail.class' => 'Swift_Transport_MailTransport',
            'swiftmailer.transport.failover.class' => 'Swift_Transport_FailoverTransport',
            'swiftmailer.init_file' => '/Development/symfony-standard/vendor/swiftmailer/lib/swift_init.php',
            ...
            'swiftmailer.base_dir' => '/Development/symfony-standard/vendor/swiftmailer/lib',
            ...
            'doctrine.orm.proxy_dir' => '/Development/symfony-standard/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/Development/symfony-standard/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Development/symfony-standard/app/../web',
            'assetic.write_to' => '/Development/symfony-standard/app/../web',
